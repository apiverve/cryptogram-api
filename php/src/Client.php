...
/**
 * Client for the Cryptogram Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/cryptogram?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/cryptogram';
    ...
    private const VALIDATION_RULES = [
        ...
        'random' => ['type' => 'boolean', 'required' => false],
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CryptogramClient] {$message}\n";
        }
    }
}
