// Package cryptogram provides a Go client for the Cryptogram Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/cryptogram?utm_source=go&utm_medium=readme
package cryptogram
...
const (
	baseURL        = "https://api.apiverve.com/v1/cryptogram"
	defaultTimeout = 30 * time.Second
)

// Client is the Cryptogram Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Cryptogram Generator API client.
...
// Execute makes a request to the Cryptogram Generator API with typed parameters.
//
...
//   - text: string - Text to encode (max 500 characters) [maxLength: 500]
//   - random: boolean - Use a random famous quote
