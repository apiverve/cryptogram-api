...
// Request contains the parameters for the Cryptogram Generator API.
//
// Parameters:
...
type Request struct {
	...
	Random bool `json:"random,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"text": {Type: "string", Required: false, MaxLength: intPtr(500)},
...
// ResponseData contains the data returned by the Cryptogram Generator API.
...
// CipherData represents the cipher object.
