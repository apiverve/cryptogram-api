# Cryptogram Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:cryptogram-api:1.1.13'
}
```
...
```java
import com.apiverve.cryptogram.CryptogramGeneratorAPIClient;
import com.apiverve.cryptogram.APIResponse;
import com.apiverve.cryptogram.APIException;

// Initialize the client
CryptogramGeneratorAPIClient client = new CryptogramGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "The quick brown fox");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/cryptogram](https://docs.apiverve.com/ref/cryptogram)
...
- **Documentation:** [https://docs.apiverve.com/ref/cryptogram](https://docs.apiverve.com/ref/cryptogram)
- **Issues:** [GitHub Issues](https://github.com/apiverve/cryptogram-api/issues)
