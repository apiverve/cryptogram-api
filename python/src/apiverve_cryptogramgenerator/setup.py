...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/cryptogram',
        'Source': 'https://github.com/apiverve/cryptogram-api',
        'Bug Tracker': 'https://github.com/apiverve/cryptogram-api/issues'
    },
    classifiers=[
